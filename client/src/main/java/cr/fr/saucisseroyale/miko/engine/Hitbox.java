...
public abstract class Hitbox {
   ...
   */
  public final static boolean collide(Hitbox h1, MapPoint m1, Hitbox h2, MapPoint m2) {
    ...
    if (h1 instanceof Rectangle) {
      if (h2 instanceof Rectangle) {
        ...
        throw new IllegalArgumentException("Unknown hitbox type for h2 : " + h2.toString());
      }
      ...
      throw new IllegalArgumentException("Unknown hitbox type for h1 : " + h1.toString());
    }
  }
  ...
  private static boolean rectangleCollide(Rectangle h1, MapPoint m1, Rectangle h2, MapPoint m2) {
    ...
    if (upLeft1.getY() < downRight2.getY() || upLeft2.getY() < downRight1.getY()) {
      return false;
    }
    return true;
  }
